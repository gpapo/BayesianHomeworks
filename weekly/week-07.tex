 ...
 \item First of all, we represent the hierarchical model through a DAG
       ...
       \begin{align*}
        p(\mu | \theta_1, \ldots, \theta_m, \tau^2, \sigma^2, \mathbf y_1, \ldots, \mathbf y_m)
         ...
         &= \frac{p(\mu, \theta_1, \ldots, \theta_m, \tau^2, \sigma^2, \mathbf y_1, \ldots, \mathbf y_m)}
                 {\int p(\mu, \theta_1, \ldots, \theta_m, \tau^2, \sigma^2, \mathbf y_1, \ldots, \mathbf y_m) \dd \mu} \\
 ...
 \item The PDF of Student's t distribution
       ...
       \begin{align*}
        \E[X^2]
         ...
         &= \int_{-\infty}^{\infty} x^2 \cdot c \cdot \left( 1 + \frac{x^2}{n} \right)^{-\frac{n + 1}{2}} \dd x
         \intertext{\raggedleft Change of variable $ t = \left( 1 + \frac{x^2}{n} \right)^{-1} $}
         &= n ^{\frac{3}{2}} \cdot c \cdot \int_{0}^{1} t ^{\frac{n}{2} - 2} (1 - t) ^{\frac{1}{2}} \dd t \\
         ...
         &= n ^{\frac{3}{2}} \cdot \frac{1}{\sqrt{n} \Beta\left( \frac{n}{2}, \frac{1}{2} \right)} \cdot 
         ...
         &= \frac{n}{n - 2}
       \end{align*}
       In this case the condition is $ n > 2 $, otherwise the integral of 
